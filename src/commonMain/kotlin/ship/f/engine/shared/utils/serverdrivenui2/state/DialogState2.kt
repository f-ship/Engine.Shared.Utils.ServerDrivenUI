...
import ship.f.engine.shared.utils.serverdrivenui2.config.trigger.models.OnDismissTrigger2
import ship.f.engine.shared.utils.serverdrivenui2.config.trigger.models.OnInitialRenderTrigger2
import ship.f.engine.shared.utils.serverdrivenui2.config.trigger.modifiers.OnDismissModifier2

@Serializable
@SerialName("DialogState2")
data class DialogState2(
    ...
    override val onDismissTrigger: OnDismissTrigger2,
    val delay: Int = 0,
    val duration: Int = 0,
) : State2(),
    ChildrenModifier2<DialogState2>,
    PaddingModifier2<DialogState2>,
    OnDismissModifier2
{
