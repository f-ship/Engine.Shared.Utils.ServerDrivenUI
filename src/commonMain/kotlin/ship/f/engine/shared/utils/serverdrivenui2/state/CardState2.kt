...
@Serializable
@SerialName("CardState2")
data class CardState2(
    ...
    override val alignment: Alignment2 = Alignment2.HorizontalAndVerticalAlignment2.Center2,
    ...
    AlignmentModifier2<CardState2>,
    ColorModifier2<CardState2>,
    ShapeModifier2<CardState2>,
    InnerPaddingModifier2<CardState2>,
    BorderModifier2<CardState2>,
    OnClickModifier2 {
