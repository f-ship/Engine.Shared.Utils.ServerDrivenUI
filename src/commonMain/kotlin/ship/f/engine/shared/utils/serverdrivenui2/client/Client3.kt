...
//import ship.f.engine.shared.utils.serverdrivenui2.config.state.models.Path2.Root
//import ship.f.engine.shared.utils.serverdrivenui2.config.state.models.Path3
...
//
//abstract class Client3(open val projectName: String? = null) {
//    val idStateMap: MutableMap<StateId2, State2> = mutableMapOf()
//    val idPathsMap: MutableMap<StateId2, List<Path3>> = mutableMapOf()
//    val pathStateMap: MutableMap<Path3, MutableState<State2>> = mutableMapOf()
//    val idMetaMap: MutableMap<Id2, Meta2> = mutableMapOf()
...
//    val backstack: SnapshotStateList<BackStackEntry2> = mutableStateListOf()
//    fun hasFired(action: Action2) = firedActionMap[action.id] != null
//    fun addFired(action: Action2) { firedActionMap[action.id] = action }
...
//
//    fun getRoots(stateId2: StateId2): List<MutableState<State2>> {
//        val paths = idPathsMap[stateId2] ?: error("getRoot => idPathsMap => not found for stateId: ${stateId2.str}")
//        val rootPaths = paths.filterIsInstance<Path3.Root>().apply { if (isEmpty()) sduiLog("getRoot => filterIsInstance => isEmpty", tag = "getRoot") }
//        val states = rootPaths.map { rootPath ->
//            pathStateMap[rootPath] ?: error("getRoot => pathStateMap => not found for $rootPath")
//        }
//        return states
//    }
//
//    inline fun <reified T : State2> getRooteds(stateId2: StateId2): List<T> {
//        val paths = idPathsMap[stateId2] ?:
//    }
//
//    inline fun <reified T : State2> getStrandeds(stateId2: StateId2): List<T> {
//        TODO()
//    }
//
//    inline fun <reified T : State2> getVoids(stateId2: StateId2): T {
//        TODO()
//    }
//
//
...
//
//    fun get(metaId2: MetaId2): Meta2 = idMetaMap.g2(metaId2)
//
//    fun update(
//        state: State2,
