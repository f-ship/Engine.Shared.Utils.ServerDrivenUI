...
@Serializable
@SerialName("CheckboxState2")
data class CheckboxState2(
    ...
    val uncheckedBorderColor: Color2 = Color2.Unspecified,
    val uncheckedBoxColor: Color2 = Color2.Unspecified,
