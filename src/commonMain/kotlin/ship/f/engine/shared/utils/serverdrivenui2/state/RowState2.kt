...
@Serializable
@SerialName("RowState2")
data class RowState2(
    ...
    ArrangementModifier2<RowState2>,
    AlignmentModifier2<RowState2>,
    ColorModifier2<RowState2>,
    ShapeModifier2<RowState2>,
    InnerPaddingModifier2<RowState2>,
    BorderModifier2<RowState2>,
    OnClickModifier2 {
