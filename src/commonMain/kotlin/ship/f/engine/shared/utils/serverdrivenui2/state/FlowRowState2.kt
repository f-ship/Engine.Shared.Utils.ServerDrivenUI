...
@Serializable
@SerialName("FlowRowState2")
data class FlowRowState2(
    ...
    override val alignment: Alignment2 = Top2,
    ...
    ArrangementModifier2<FlowRowState2>,
    AlignmentModifier2<FlowRowState2>,
    ColorModifier2<FlowRowState2>,
    ShapeModifier2<FlowRowState2>,
    InnerPaddingModifier2<FlowRowState2>,
    BorderModifier2<FlowRowState2> {
