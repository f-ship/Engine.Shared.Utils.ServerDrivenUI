...
@Serializable
@SerialName("LazyGridState2")
data class LazyGridState2(
    ...
    ChildrenModifier2<LazyGridState2>,
    AlignmentModifier2<LazyGridState2>,
    ArrangementModifier2<LazyGridState2>,
    ColorModifier2<LazyGridState2>,
    ShapeModifier2<LazyGridState2>,
    InnerPaddingModifier2<LazyGridState2>,
    BorderModifier2<LazyGridState2> {
